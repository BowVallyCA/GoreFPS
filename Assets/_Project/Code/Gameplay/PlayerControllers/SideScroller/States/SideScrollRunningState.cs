...
{
    public class SideScrollRunningState : SideScrollBaseState
    {
        private float _currentSpeed;

        public SideScrollRunningState(SideScrollerController controller) : base(controller)
        {
        }
        ...
        public override void Update()
        {
            ...
            var targetSpeed = Mathf.Abs(_controller.MoveInput.x) > 0.01f ? _controller.MovementProfile.RunSpeed : 0f;
